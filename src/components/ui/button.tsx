...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-nature hover:shadow-glow",
        destructive:
        ...
        hero: "bg-gradient-nature text-primary-foreground hover:bg-gradient-hero shadow-nature hover:shadow-glow hover:-translate-y-1 transition-spring font-semibold",
        nature: "bg-primary text-primary-foreground hover:bg-primary-glow shadow-nature hover:shadow-glow",
        water: "bg-secondary text-secondary-foreground hover:bg-secondary-glow shadow-card hover:shadow-glow",
      },
      size: {
